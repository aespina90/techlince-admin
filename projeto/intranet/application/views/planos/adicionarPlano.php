            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formServico" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="descricao" type="text" name="descricao" value="<?php echo set_value('descricao'); ?>"  autocomplete="off" />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3">
                                ...
                                <a href="<?php echo base_url() ?>index.php/planos" id="btnAdicionar" class="btn"><i class="icon-arrow-left"></i> Voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
