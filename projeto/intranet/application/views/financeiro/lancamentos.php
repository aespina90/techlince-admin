  ...
  <div class="modal-body">
    	...
    	<div class="span12" style="margin-left: 0"> 
			...
			<select name="descricao" id="descricao" class="span12" value="descricao">
		    			<option value="Pagamento Integral de Mensalidade">Pagamento Integral de Mensalidade</option>
		    			<option value="Pagamento Parcial de Mensalidade">Pagamento Parcial de Mensalidade</option>			
		    			<option value="Crédito Cliente">Crédito Cliente</option>			
		    			<option value="Bônus">Bônus</option>
						<option value="Bônus">Outros</option>				
		    </select>
    	</div>	
