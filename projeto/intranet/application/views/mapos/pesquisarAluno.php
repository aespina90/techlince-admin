...
if (isset($_POST['pagar'])) {
	...
	$aluno = $_POST['aluno'];
		...
		$sql4 = mysql_query("INSERT INTO `lancamentos` VALUES ('','Mens. $primeiroNome $ultimoNome <strong>[id $id]</strong>','".$valor."','".$data_atual."','1','$nome_emitente','Dinheiro','receita','$aluno','1')");
