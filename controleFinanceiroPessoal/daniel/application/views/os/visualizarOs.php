                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">#Orçamento: <span ><?php echo $result->idOs?></span></br> </br> <span>Emissão: <?php echo date('d/m/Y')?></span></td>
                                </tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function Popup(data)
        {
            ...
            mywindow.document.write('<html><head><title>Orçamento Nº <?php echo $result->idOs?> - <?php echo $result->nomeCliente?></title>');
