              ...
              <div class="span12">
                  ...
                  <div class="widget-box">
                      <div class="widget-title">
                          <h4 style="text-align: center">Relatório Financeiro - Daniel Ricomine</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">Fornecedor</th>-->
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">Data Pgto</th>
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td colspan="1" style="text-align: right; color: green"><strong>R$ <?php echo number_format($totalReceita,2,',','.') ?></strong></td>
                          </tr>
                          <tr>
                            <td colspan="4" style="text-align: right; color: red"> <strong>Total Despesas:</strong></td>
                            <td colspan="1" style="text-align: right; color: red"><strong>R$ <?php echo number_format($totalDespesa,2,',','.') ?></strong></td>
                          </tr>
                          <tr>
                            <td colspan="4" style="text-align: right"> <strong>Saldo:</strong></td>
                            <td colspan="1" style="text-align: right"><strong>R$ <?php echo number_format($totalReceita - $totalDespesa,2,',','.') ?></strong></td>
                          </tr>
                      </tbody>                  
</table> 
