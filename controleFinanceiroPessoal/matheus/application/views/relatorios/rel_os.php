    ...
    <div class="span4">
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul class="site-stats">
                    <li><a href="<?php echo base_url()?>index.php/relatorios/osRapid"><i class="icon-list"></i> <small>Todos os Orçamentos</small></a></li>
                ...
                <div class="span12 well">
                    ...
                    <form action="<?php echo base_url() ?>index.php/relatorios/osCustom" method="get">
                        ...
                        <div class="span12" style="margin-left: 0">
                            <div class="span6">
                                <input type="hidden" name="status" value="Orçamento" />
                            </div>
